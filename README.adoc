...
----
$ git clone git@github.com:lholmquist/vertx-try-1
...
. Stop your booster.
. Make your change (e.g. edit link:https://github.com/lholmquist/vertx-try-1/edit/master/{fileLocation}[`{fileLocation}`]).
